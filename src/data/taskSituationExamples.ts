...
const copies: Record<string, ExampleCopy> = {
  ...
  "fragrance-final-decision": {
    ...
    delivery: "许宁已在讨论中提交预算、人群包与预期贡献测算；当前仍在推进，等待最终确认。",
    attention: "测算提交不代表决策已确认，尚需完整的预算边界与结果依据。",
    next: "周岚先取得合规结论，再核对预算上限、停止条件与执行边界。",
  },
  "weekly-retro-notes": {
    summary: "纪要草稿已形成，决定清单已确认，问题边界和部分行动承诺仍待核对。",
    delivery: "陈默于 9/14 12:00 确认决定清单；4 项问题已整理影响范围，6 条行动中有 3 条已确认责任和期限。",
    attention: "Q07 的确认人、A03 的交付日期在两份记录中不一致，另外 3 条行动仍待成员回复。",
    next: "林洁与周岚在 9/15 上午核对 Q07 和行动承诺，修订后共享纪要。",
  },
};

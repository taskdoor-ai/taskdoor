...
export const creatorCommerceAdditionNodes: TaskNode[] = [
  ...
  cc({ id: "ccx-serum-commerce-track", name: "建立精华首发交易与增长保障", parentTaskId: "ccx-serum-launch", ownerId: "梁川", participantIds: ["许宁", "韩序"], status: "待审核", goal: "让价格、库存、投放和归因围绕同一首发范围协同运行。", completionCriteria: ["价格库存与预算方案均引用同一 SKU 范围", "归因看板可解释预算调整"], executionTips: ["只在叶子交付中记录人工投入"], plannedStartOn: "2026-08-22", plannedEndOn: "2026-09-18", dueAt: "9 月 18 日", labels: ["商品运营", "投流增长"], iconName: "chart", iconTone: "cyan" }),
  ...
  cc({ id: "ccx-serum-budget-gate", name: "核准精华首发投流预算与止损线", parentTaskId: "ccx-serum-commerce-track", ownerId: "许宁", participantIds: ["周岚", "韩序"], dependsOnTaskIds: ["ccx-serum-price-stock", "ccx-serum-asset-batch"], status: "待审核", goal: "依据毛利、素材供给和人群规模形成分阶段预算与止损条件。", completionCriteria: ["冷启、放量和追投预算分别有触发条件", "ROI 与消耗异常的停止线可自动监测", "追加预算仍需负责人书面决定"], executionTips: ["达人自然流量不计为已购买曝光"], plannedStartOn: "2026-09-01", plannedEndOn: "2026-09-08", dueAt: "9 月 8 日", labels: ["投流增长", "高优先级"], iconName: "chart", iconTone: "red", minutes: 480 }),
  ...
  cc({ id: "ccx-october-studio-calendar", name: "冻结十月直播间资源日历", ownerId: "高远", participantIds: ["林洁", "梁川"], status: "待审核", goal: "协调自播、达人连麦和大促彩排的直播间、场控与设备资源。", completionCriteria: ["所有已确认活动有场地、场控和主备设备", "冲突时段有书面取舍", "临时需求的最晚申请时间已公布"], executionTips: ["未确认活动只保留候选时段"], plannedStartOn: "2026-08-28", plannedEndOn: "2026-09-04", dueAt: "9 月 4 日", labels: ["直播执行"], iconName: "clipboard-check", iconTone: "purple", minutes: 300 }),
...
export const customerSuccessAdditionNodes: TaskNode[] = [
  ...
  cs({ id: "csx-retail-outcome-evidence", name: "核对华东零售门店协同成效", parentTaskId: "csx-retail-evidence-track", ownerId: "陈沁", participantIds: ["白露"], dependsOnTaskIds: ["csx-retail-usage-baseline", "csx-retail-support-closure"], status: "待审核", goal: "核对门店任务准时率、总部催办和异常闭环改善是否可归因于已用能力。", completionCriteria: ["基线期与观察期口径一致", "产品贡献与同时发生的流程调整分开", "结论经客户业务负责人确认或标记待确认"], executionTips: ["相关性不足时不声称因果"], plannedStartOn: "2026-09-01", plannedEndOn: "2026-09-08", dueAt: "9 月 8 日", labels: ["客户影响"], iconName: "chart", iconTone: "purple", minutes: 480 }),
  ...
  cs({ id: "csx-health-score-calibration", name: "完成三季度客户健康分校准", parentTaskId: "csx-health-action-track", ownerId: "白露", participantIds: ["陈沁", "江予"], dependsOnTaskIds: ["csx-health-data-freshness"], status: "待审核", goal: "用已知续约、扩容和流失样本检验健康分分层是否可用于当前行动。", completionCriteria: ["样本来源和时间范围明确", "误报与漏报客户完成原因复核", "校准结论注明不适用客户"], executionTips: ["离线校准不声称预测未来续约概率"], plannedStartOn: "2026-09-01", plannedEndOn: "2026-09-08", dueAt: "9 月 8 日", labels: ["数据修复"], iconName: "chart", iconTone: "purple", minutes: 600 }),

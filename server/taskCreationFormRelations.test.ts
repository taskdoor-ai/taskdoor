...
test("新子任务列表只展示名称与待接受负责人，不展开完成标准", () => {
  const html = renderToStaticMarkup(createElement(TaskSubtaskList, { tasks: [{ id: "new", title: "交付脚本", goal: "主任务目标", completionCriteria: ["脚本评审通过"], owner: "", proposedOwnerId: "林洁", dueAt: "未设置", status: "待开始" }] }));

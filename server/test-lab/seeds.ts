...
export function seedLab():LabState{
  const team:LabTeam={id:'lab-content',name:'星禾品牌内容团队',industry:'品牌与内容',description:'合成测试团队：文案、设计、运营与审核协作；不对应真实个人。',archived:false,
  ...
  const online=onlineCollaborationSeed();
  return {version:1,revision:0,teams:[team,...online.teams],cases:[...cases,...online.cases],runs:[]};
}
